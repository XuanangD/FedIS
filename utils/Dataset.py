...
class Dataset(object):
    ...
    def __init__(self,path):
        ...
        self.train_data = [(self.trainMatrix[i, :], self.trainList[i]) for i in range(self.num_users)]
        self.test_data = [(self.testRatings[i], self.testNegatives[i]) for i in range(self.num_users)]
        print('already load the user data...')
        print('Number of items', self.num_items)
        print('Number of users', self.num_users)
        print('Number of training ratings', np.sum([len(self.trainList[e]) for e in range(self.num_users)]))
        print('Number of testing ratings', np.sum([len(self.testRatings) ]))
